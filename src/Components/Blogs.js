  ...
  return (
    <>
      ...
      <span className={Styles.heading}><span>BLOGS</span><hr /></span>
        <p>Why do I write blog? First of all, it's a great way to express myself and share my thoughts with the world. And second, it's a nice feeling to see that people actually read and enjoy my blog. Here are some featured blogs of them...
        </p>
        ...
        <Link to="/blogs" className={Styles.linkTag}><h4 onClick={()=>window.scrollTo({ top: 0, behavior: 'smooth'})}>SEE MORE</h4></Link>
      </div>
    </>
  )
}
